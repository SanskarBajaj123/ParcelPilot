...
SNAPSHOT_TIME = "2026-08-16 11:00 IST"   # from xlsx README sheet
...
PRIORITY 3 — Current SOPs & Product Documentation
...
PRIORITY 4 — Historical Ticket Resolutions  (LOWEST — CONTEXT ONLY)
  → MAY CONTAIN INCORRECT PAST GUIDANCE. Never cite as policy or authority.

⛔ NEVER USE: 02_Support_Policy_v2_DEPRECATED.pdf
...
def build_retrieved_context_block(chunks: list[dict], conflict: bool) -> str:
    ...
    for i, chunk in enumerate(chunks, 1):
        ...
        lines.append(
            ...
            f"File: {chunk['source_file']} | Page {chunk.get('page_num', '?')}\n"
            f"{chunk['content']}\n"
        )
